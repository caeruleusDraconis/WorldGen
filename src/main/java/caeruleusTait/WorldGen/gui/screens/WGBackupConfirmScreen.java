...
public class WGBackupConfirmScreen extends Screen {
    private final Runnable onConfirm;
    private final Screen parent;

    private MultiLineLabel multiLineLabel;

    public WGBackupConfirmScreen(Screen _parent, Runnable _onConfirm) {
        super(new TranslatableComponent("world-gen.backup.title"));
        parent = _parent;
    ...
    protected void init() {
        ...
        multiLineLabel = MultiLineLabel.create(font, new TranslatableComponent("world-gen.backup.description"), width - 50);
    ...
    public void render(PoseStack poseStack, int i, int j, float f) {
        ...
        drawCenteredString(poseStack, this.font, this.title, this.width / 2, 25, 0xFFFFFF);
