...
public class WGBackupConfirmScreen extends Screen {
    ...
    public WGBackupConfirmScreen(Screen _parent, Runnable _onConfirm) {
        super(Component.translatable("world-gen.backup.title"));
        parent = _parent;
    ...
    protected void init() {
        ...
        multiLineLabel = MultiLineLabel.create(font, Component.translatable("world-gen.backup.description"), width - 50);
