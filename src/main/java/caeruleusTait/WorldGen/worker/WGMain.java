...
public class WGMain {
    ...
    public WGMain(Minecraft _minecraft, String _levelID) throws IOException, ExecutionException, InterruptedException {
        ...
        worldStem = minecraft.makeWorldStem(
                packRepository,
                true,
                WorldStem.DataPackConfigSupplier.loadFromWorld(levelStorageAccess),
                WorldStem.WorldDataSupplier.loadFromWorld(levelStorageAccess)
        );
